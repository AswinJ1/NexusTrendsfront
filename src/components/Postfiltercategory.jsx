...
const PostFilterCategory = () => {
    ...
    const filterByCategory = (category) => {
        setSelectedCategory(category === selectedCategory ? null : category); // Deselect if the same category is clicked
    };
    ...
    return (
        <>
            ...
            <section className="bg-indigo-50">
                <div className="flex space-x-4 p-6 bg-white shadow-md dark:bg-slate-900 justify-center">
                    <button
                    ...
                    {[
                        ...new Set(
                            posts
                                .map((post) => post.category && post.category.toLowerCase())
            ...
            {/* Posts Section */}
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-gray-100 dark:bg-slate-900">
                {filteredPosts.length === 0 ? (
                    ...
                    filteredPosts.map((post) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                <div
                                    className="text-sm text-gray-500 uppercase tracking-wide font-semibold mb-2 cursor-pointer"
                                    onClick={() => filterByCategory(post.category.toLowerCase())}
                                >
                                    {post.category}
                                </div>
...
export default PostFilterCategory;
